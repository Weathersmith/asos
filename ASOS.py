...
sky_label = tk.Label(data_frame, text="SKY", font=('Terminal', 12), background='black', foreground='white')
...
vis_label = tk.Label(data_frame, text="VISIBILITY", font=('Terminal', 12), background='black', foreground='white')
...
temp_td_label = tk.Label(data_frame, text="TEMP/DEWPT", font=('Terminal', 12), background='black', foreground='white')
...
rvr_label = tk.Label(data_frame, text="RVR", font=('Terminal', 12), background='black', foreground='white')
...
wind_label = tk.Label(data_frame, text="WIND DIR/SPD", font=('Terminal', 12), background='black', foreground='white')
...
wx_label = tk.Label(data_frame, text="PRESENT WX", font=('Terminal', 12), background='black', foreground='white')
...
altmtr_label = tk.Label(data_frame, text="ALTIMETER", font=('Terminal', 12), background='black', foreground='white')
